...
4. Press F16, F17, F18, F19, or their Ctrl and Ctrl+Shift variants.
...
Extra High on F16–F19, and GPT-6 Sol at the same effort levels on
Ctrl+F16–Ctrl+F19. Ctrl+Shift+F16–F19 select GPT-6 Luna at the same levels.
Ordinary Chat's separate catalog does not expose GPT-6 Astra, Sol or Luna on the
tested 26.915.4065.0 app. Upgrades preserve the active configuration, so an
