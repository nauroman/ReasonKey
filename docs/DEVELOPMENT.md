...
3. Current unified picker in ChatGPT:
   ...
   - Ctrl+F16–Ctrl+F19 and Ctrl+Shift+F16–F19 → the same independent Chat Power levels as F16–F19;
...
Recorded [1.0.12 release evidence](diagnostics/release-1.0.12.md),
[1.0.11 release evidence](diagnostics/release-1.0.11.md),
